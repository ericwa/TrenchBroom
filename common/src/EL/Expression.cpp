...
namespace TrenchBroom {
    namespace EL {
        ...
        m_expression(expression) {
            ensure(m_expression.get() != NULL, "m_expression.get() is null");
        }
        ...
        ExpressionBase(line, column),
        m_operand(operand) {
            ensure(m_operand != NULL, "m_operand is null");
        }
        ...
        m_indexOperand(indexOperand) {
            ensure(m_indexableOperand != NULL, "m_indexableOperand is null");
            ensure(m_indexOperand != NULL, "m_indexOperand is null");
        }
        ...
        m_rightOperand(rightOperand) {
            ensure(m_leftOperand != NULL, "m_leftOperand is null");
            ensure(m_rightOperand != NULL, "m_rightOperand is null");
        }
